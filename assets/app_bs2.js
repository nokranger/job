$('.example_typeahead > > input').tagsinput({
  typeahead: {
    source: function(query) {
      return $.getJSON('assets/programming_name.json');
    }
  }
});
...
$('.example_objects_as_tags > > input').tagsinput({
  ...
  typeahead: {
    source: function(query) {
      return $.getJSON('assets/programming.json');
    }
  }
});
$('.example_objects_as_tags > > input').tagsinput('add', { "value": "Python" , "text": "Python" });
$('.example_objects_as_tags > > input').tagsinput('add', { "value": "C++" , "text": "C++" });
$('.example_objects_as_tags > > input').tagsinput('add', { "value": "Java" , "text": "Java" });
$('.example_objects_as_tags > > input').tagsinput('add', { "value": "C" , "text": "C" });
$('.example_objects_as_tags > > input').tagsinput('add', { "value": "C#" , "text": "C#" });
